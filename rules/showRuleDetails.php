<html lang="en">
    ...
    <body class="bg-light">
        ...
        <main role="main" class="container">
            <!--Info del SID-->
            <div class="container" id="sid-table">
                <?php
...
<div class="d-flex align-items-center p-3 my-3 text-white-50 bg-low-blue rounded shadow-sm">
                <img class="mr-3" src="../img/owlimg/owlhblack.png" alt="" height="48">
                <div class="lh-100">
                    <h3 class="mb-0 text-white lh-100"><?php $sid ?></h3>
                    <small>Rules</small>
                </div>
            </div>
...
<?php
                        ...
                        echo "<br><br><h1 align='center'>Rule info <br> SID $sid - $matches[1]</h1><br><br>";
                        
                        echo ' <table align="center" style="width:75%;table-layout:fixed"> <tr> <th colspan="2">Rule detail - RAW</th> </tr> <tr><td colspan="2" style="word-wrap:break-word">';
                        echo $line;
                        echo '<br><br></td></tr>';
                        echo '<tr><td colspan="2" style="text-align:center"><a href="#">Disable rule</a><br><br><br></td></tr>';
                        echo '</table><table  align="center" style="width:75%;table-layout:fixed">';
